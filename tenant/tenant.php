...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li><a href="<?php echo WEB_URL; ?>tenant.php"><i class="fa fa-dashboard"></i> <?php echo $_data['home_breadcam'];?></a></li>
  ...
  <div class="row home_dash_box">
    ...
    <div class="col-lg-3 col-xs-6">
      <div class="small-box bg-aqua">
        ...
        <a href="<?php echo WEB_URL; ?>unit_details.php" class="small-box-footer"><?php echo $_data['dashboard_more_info'];?> <i class="fa fa-arrow-circle-right"></i></a> </div>
    </div>
    <!-- ./col end -->
  </div>
  <!-- /.row end -->
